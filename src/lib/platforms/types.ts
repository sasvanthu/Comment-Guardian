...
export type PlatformId = "twitter" | "facebook" | "instagram" | "youtube" | "linkedin" | "pinterest";

export const PLATFORM_IDS: readonly PlatformId[] = ["facebook", "instagram", "youtube", "linkedin", "twitter", "pinterest"] as const;
